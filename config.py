...
train_annotations_file = '/media/data/hojjat_data/affectnet/original.csv' # '/home/hojjat/widerface/wider_face_split/wider_face_train_bbx_gt.txt'  '/media/data/hojjat_data/multiaffectnet/file_list.csv'
gpu_index = "2"
input_shape = 416
max_boxes = 10
jitter = 0.3
...
obj_threshold = 0.3
nms_threshold = 0.5
log_dir = './logs/affectnet_001_class_softmax_only13_3'
data_dir = '/media/data/hojjat_data/affectnet'
model_dir = './test_model/affectnet_001_class_softmax_only13_3'
