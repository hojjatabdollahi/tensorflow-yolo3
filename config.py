...
log_dir = './logs'
data_dir = './model_data'
model_dir = './test_model/affectent'
...
classes_path = './model_data/multiaffectnet_classes.txt'
train_data_file = 'D:/MachineLearning/WIDER_train/images'
val_data_file = '/data0/dataset/coco/val2017'
train_annotations_file = 'D:/MachineLearning/wider_face_split/wider_face_train_bbx_gt.txt'
